...
class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            text: "",
            data: {},
            api: "http://157.230.43.83:3001/api",
            isLoading: true,
            main: true,
            history:'5935512004'
        }
    ...
    select1 = (evt) =>(
        this.send1(evt),
        this.props.addHistory(' '+this.state.data.history),
                ...
                <Paper>
                    ...
                    <Grid container spacing={12} >
                        ...
                        <Grid item xs={8} sm={8} style={boxMessage}>
                            <Paper style={mastyle} onClick={this.select1}>{this.state.data.symptom.U1.title}</Paper>
                            <Paper style={mastyle} onClick={this.select2} >{this.state.data.symptom.U2.title}</Paper>
                        </Grid>
                        <Grid item xs={2} sm={2} align='center'>
